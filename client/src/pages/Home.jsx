...
import { 
  Leaf, ChevronRight, Timer, BookOpen, Sun, ArrowUp, Minus,
  CalendarDays as Calendar, Moon, Library 
} from "lucide-react";
    ...
    <>
      <div className="md:hidden bg-white border-b border-neutral-200 shadow-sm sticky top-0 z-10">
        <div className="flex overflow-x-auto whitespace-nowrap">
          <div className="flex-1 px-4 py-3 text-primary border-b-2 border-primary font-medium">
